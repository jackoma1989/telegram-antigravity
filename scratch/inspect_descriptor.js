        ...
        const res = await Runtime.evaluate({
            expression: `
                (() => {
                    ...
                    const latSum = provider.latestSummaries;
                    const descriptor = latSum ? Object.getOwnPropertyDescriptor(latSum, 'summaries') : null;
                    const protoDescriptor = (latSum && Object.getPrototypeOf(latSum)) ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf(latSum), 'summaries') : null;
                    ...
                    return {
                        ...
                        protoDescriptor: protoDescriptor ? {
                            ...
                            hasGetter: !!protoDescriptor.get,
                            hasSetter: !!protoDescriptor.set
                        } : null
                    };
                })()
            `,
