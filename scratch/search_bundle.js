        ...
        const res = await Runtime.evaluate({
            expression: `
                (() => {
                    ...
                    // Search in all functions of window and React components if possible,
                    // or look at how lsClient is used in components.
                    // Let's search inside the main bundle content using fetch!
                    return (async () => {
                        ...
                        for (const src of bundles) {
                            try {
                                ...
                                const keywords = ['updateConversationAnnotations', 'jetboxWriteSummary', 'editConversationTitle', 'renameConversation'];
                                const matches = {};
                                keywords.forEach(kw => {
