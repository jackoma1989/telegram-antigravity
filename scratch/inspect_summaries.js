        ...
        const res = await Runtime.evaluate({
            expression: `
                (() => {
                    ...
                    const summaries = provider.latestSummaries ? provider.latestSummaries.summaries : null;
                    const sampleSummaryKey = summaries ? Object.keys(summaries)[0] : null;
                    const sampleSummaryVal = sampleSummaryKey ? summaries[sampleSummaryKey] : null;
                    
                    return {
                        hasSummaries: !!summaries,
                        sampleSummaryKey,
                        sampleSummaryType: typeof sampleSummaryVal,
                        sampleSummaryVal: sampleSummaryVal ? {
                            trajectoryId: sampleSummaryVal.trajectoryId,
                            summary: sampleSummaryVal.summary,
                            hasLastModifiedTime: !!sampleSummaryVal.lastModifiedTime
                        } : null
                    };
                })()
            `,
