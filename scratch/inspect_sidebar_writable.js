...
async function run() {
    try {
        ...
        const res = await Runtime.evaluate({
            expression: `
                (() => {
                    ...
                    const propDesc = Object.getOwnPropertyDescriptor(c, 'summary');
                    const protoPropDesc = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(c) || {}, 'summary');
                    
                    let mutationSuccess = false;
                    let mutationError = null;
                    const originalVal = c.summary;
                    try {
                        c.summary = "MUTATION_TEST";
                        mutationSuccess = (c.summary === "MUTATION_TEST");
                        c.summary = originalVal;
                    } catch(e) {
        ...
        console.log("SIDEBAR CONVERSATION MUTATION DIAGNOSTIC:");
