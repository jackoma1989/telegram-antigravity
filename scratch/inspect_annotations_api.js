...
async function run() {
    try {
        ...
        const res = await Runtime.evaluate({
            expression: `
                (async () => {
                    ...
                    // Let's inspect updateConversationAnnotations method parameters/toString
                    const methodStr = ls.updateConversationAnnotations.toString();
        ...
        console.log("ANNOTATIONS API METHOD STRING:");
